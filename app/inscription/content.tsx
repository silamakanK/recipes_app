...
export default function Inscription() {
  ...
  const handleSubmit = (event: FormEvent<HTMLFormElement>) => {
    ...
    startTransition(async () => {
      ...
      if (!result.success) {
        setFeedback(result.message ?? "Une erreur est survenue.");
        return;
      }
          ...
          <div className="relative flex h-full flex-col justify-between p-10 text-white sm:p-12">
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-sm text-base text-white/80">
                Gérez vos menus, découvrez de nouvelles saveurs et suivez vos
                analyses nutritionnelles à deux.
              </p>
            </div>
        ...
        <div className="mx-auto max-w-md overflow-hidden rounded-[32px] border border-brand-soft bg-white shadow-[0_25px_80px_rgba(96,153,62,0.2)]">
          ...
          <div className="space-y-6 px-6 py-6">
            <div className="overflow-hidden rounded-2xl bg-slate-100">
              <Image
                src={HERO_IMAGE}
                alt="Ingrédients frais et IA culinaire"
                width={700}
                height={480}
            ...
            <div>
              <h2 className="text-2xl font-semibold text-slate-900">
                Rejoignez la cuisine du futur
              </h2>
              <p className="mt-2 text-sm text-slate-500">
                Générez vos recettes idéales et suivez votre nutrition dès
                aujourd&apos;hui.
              </p>
            </div>
  ...
  return (
    <form className="mt-8 space-y-5" onSubmit={onSubmit}>
      ...
      <div>
        ...
        <div
          className={`mt-2 flex items-center gap-3 rounded-2xl ${borderColor} ${fieldBackground} px-4 py-3`}
        >
      ...
      <div>
        ...
        <p className={`mt-2 text-xs ${mutedText}`}>Au moins 8 caractères</p>
      </div>

      <div>
        <label
          className="text-sm font-medium text-slate-600"
          htmlFor={`passwordConfirmation-${variant}`}
        >
        ...
        >
          ...
          <input
            ...
            id={`passwordConfirmation-${variant}`}
            placeholder="••••••••"
            autoComplete="new-password"
            minLength={8}
            required
      ...
      <button
        type="submit"
        className={`inline-flex w-full items-center justify-center gap-2 rounded-2xl px-4 py-3 text-base font-semibold text-white shadow-lg transition ${buttonClass} disabled:cursor-not-allowed disabled:opacity-60`}
        disabled={isPending}
      >
  ...
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...props}>
      ...
      <path
        strokeWidth={1.5}
        strokeLinecap="round"
        d="M5 20.5c1.5-3 4.2-4.5 7-4.5s5.5 1.5 7 4.5"
      />
    </svg>
  );
}
